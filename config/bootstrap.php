...
if (!$fullBaseUrl) {
    // Check environment variable first (production-safe)
    $envUrl = env('APP_FULL_BASE_URL');
    if ($envUrl) {
        $fullBaseUrl = $envUrl;
    } else {
...
/*
 * Set the default locale for I18n __() translations.
 * This loads the matching .po file from resources/locales/{locale}/default.po
 */
